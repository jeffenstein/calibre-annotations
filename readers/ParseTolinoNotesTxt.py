...
_LANG_AND_KIND_DETECT_BY_START_WORDS = {
    r"Highlight\son":        ('en', 'highlight'),
    r"Note\son":             ('en', 'note'),
    r"Bookmark\son":         ('en', 'bookmark'),
    r"Markierung\sauf":      ('de', 'highlight'),
    r"Notiz\sauf":           ('de', 'note'),
    r"Ihr\sLesezeichen":     ('de', 'bookmark'),
    r"Selección\sen\sla":    ('es', 'highlight'),
    r"Marcadores\sen\sla":   ('es', 'note'),
    r"Mi\smarcador":         ('es', 'bookmark'),
    r"Surlignement\sen":     ('fr', 'highlight'),
    r"Note\sen":             ('fr', 'note'),
    r"Signet\sen":           ('fr', 'bookmark'),
    r"Evidenziazione\sa":    ('it', 'highlight'),
    r"Nota\sa":              ('it', 'note'),
    r"Segnalibro\sa":        ('it', 'bookmark'),
    r"Markering\sop":        ('nl', 'highlight'),
    r"Notitie\sop":          ('nl', 'note'),
    r"Bladwijzer\sop":       ('nl', 'bookmark'),
    }
